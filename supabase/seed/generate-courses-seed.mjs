...
const S = (n) => `a0000000-0000-0000-0000-${String(n).padStart(12, '0')}`;
const C = (n) => `b0000000-0000-0000-0000-${String(n).padStart(12, '0')}`;
...
const courses = [
  {
    ...
    content: {
      ...
      cards: [
        ...
        { title: 'La méthode FORD', advice: 'Quand tu ne sais pas quoi dire, pense Famille, Occupation, loisirs (Récréation), Rêves : les 4 sujets qui ouvrent une conversation naturellement.', sourceId: S(2) },
        { title: 'Question ouverte, pas fermée', advice: "\"Qu'est-ce qui t'amène ici ce soir ?\" donne un vrai espace de réponse ; \"Tu t'amuses ?\" tue la conversation en un mot.", sourceId: S(3) },
        { title: 'Le commentaire de contexte', advice: 'Le moyen le plus simple de démarrer : commenter ce qui vous entoure, ici et maintenant.', sourceId: S(2) },
        { title: 'Pose la question, puis tais-toi vraiment', advice: 'Écoute réellement la réponse, ne prépare pas déjà ta prochaine phrase.', sourceId: S(4) },
        { title: 'Récap', advice: "Contexte ou FORD pour ouvrir, question ouverte pour laisser de la place, écart de sympathie pour te rassurer.", sourceId: null },
      ],
      exercise: {
  ...
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'mcq-nuanced',
        prompt: "Un silence de 5 secondes vient de s'installer lors d'un café avec une connaissance récente. Laquelle de ces relances est la plus efficace ?",
        options: [
          { text: "Revenir sur ce qu'elle a dit 5 minutes plus tôt et poser une question dessus", feedback: "C'est la plus efficace : elle relance un fil déjà engagé plutôt que d'ouvrir un sujet à froid ou de pointer le malaise, ce qui le renforcerait.", isBest: true },
          { text: 'Commenter la météo pour combler immédiatement', feedback: "Ouvrir un sujet totalement nouveau à froid est moins naturel qu'une relance sur un fil déjà engagé dans la conversation.", isBest: false },
          { text: 'S\'excuser d\'avoir "fait un blanc"', feedback: 'Pointer le malaise à voix haute a tendance à le renforcer plutôt qu\'à le désamorcer.', isBest: false },
        ],
      },
  ...
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'predict-compare',
        prompt: 'Qu\'est-ce que tu pourrais mettre en place dans les 2 heures après ton prochain événement social pour récupérer efficacement ?',
        examples: [
          'Silence total et lumière tamisée pendant 30 minutes en rentrant, sans écran.',
          'Une promenade seul, sans podcast ni musique, pour laisser l\'esprit se vider.',
          'Un moment de lecture plutôt qu\'une série ou les réseaux sociaux.',
        ],
      },
    },
  },
  {
    ...
    content: {
      ...
      cards: [
        ...
        { title: 'Récap', advice: 'L\'anxiété "avant" vient surtout de la rumination, pas de l\'événement ; repère tes pensées automatiques ; arrête de sur-préparer ; compare prédiction et réalité après coup.', sourceId: null },
      ],
      exercise: {
        kind: 'guided-response',
        prompt: 'Écris la pensée qui tourne en boucle avant cet événement.',
  ...
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'predict-compare',
        prompt: 'On te demande "Et toi, tu en penses quoi ?" sur un sujet que tu ne maîtrises pas du tout. Ta tête est vide. Qu\'est-ce que tu dirais ?',
        examples: [
          '"C\'est une bonne question, laisse-moi y réfléchir une seconde."',
          '"Ça me fait penser à... en fait je n\'y avais pas pensé comme ça avant."',
          '"Honnêtement je ne connais pas trop le sujet, qu\'est-ce que toi tu en penses ?"',
        ],
      },
    },
  },
  ...
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'free-plan',
        prompt: 'Identifie une activité récurrente (hebdomadaire ou mensuelle) que tu pourrais rejoindre pour accumuler du temps avec les mêmes personnes.',
        examples: [
          'Un cours collectif (sport, langue, art) qui revient chaque semaine.',
          'Un club ou une association liée à un centre d\'intérêt existant.',
          'Un groupe de jeu ou une activité régulière avec des collègues ou connaissances.',
        ],
      },
    },
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'predict-compare',
        prompt: 'Tu croises un collègue à la machine à café. Qu\'est-ce que tu dirais pour lancer une conversation courte et naturelle ?',
        examples: [
          '"Tu avances sur quoi en ce moment ?"',
          '"Tu as vu un bon film ou une série récemment ?"',
          '"Cette machine à café est capricieuse aujourd\'hui, hein ?" (commentaire de contexte)',
        ],
      },
    },
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'predict-compare',
        prompt: 'On te sollicite pour quelque chose dont tu n\'as pas envie. Écris ta réponse en utilisant la structure DESC.',
        examples: [
          '"Ce week-end je suis déjà pris (D). Ça me tient à cœur de pouvoir souffler un peu (E). Est-ce qu\'on peut se voir la semaine d\'après à la place (S) ? On profitera d\'avoir plus de temps (C)."',
          '"Je ne suis pas disponible ce soir-là (D). Je préfère être honnête plutôt que d\'annuler après (E). Je te propose une autre date (S), comme ça on est sûrs d\'en profiter vraiment (C)."',
        ],
      },
    },
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'mcq-nuanced',
        prompt: 'Tu repères un groupe de 4 personnes en cercle légèrement ouvert lors d\'un événement. Laquelle de ces approches est la plus efficace ?',
        options: [
          { text: 'S\'approcher de l\'ouverture, écouter quelques secondes, puis poser une question liée au sujet en cours', feedback: 'Respecte à la fois le positionnement spatial et le fil de la conversation.', isBest: true },
          { text: 'S\'approcher et se présenter directement à tout le groupe avant qu\'ils aient fini leur phrase', feedback: 'Casse la dynamique en cours.', isBest: false },
          { text: 'Attendre un silence total du groupe avant d\'oser s\'approcher', feedback: 'Risque de ne jamais arriver, un silence total étant rare dans un groupe animé.', isBest: false },
        ],
      },
    },
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'predict-compare',
        prompt: 'Un ami te partage un problème. Qu\'est-ce que tu dirais juste après qu\'il ait fini de parler ?',
        examples: [
          '"Si je comprends bien, ce qui te pèse le plus c\'est... c\'est ça ?"',
          '"Ça a l\'air vraiment difficile à vivre, merci de me le partager."',
          '"Attends, donc concrètement, ce qui t\'embête c\'est plutôt X ou Y ?"',
        ],
      },
    },
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'guided-response',
        prompt: 'Repense à un moment récent où tu t\'es senti ignoré ou exclu. Écris la phrase que tu t\'es dite sur toi-même à ce moment-là.',
  ...
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'predict-compare',
        prompt: 'Pense à quelqu\'un que tu vois régulièrement. Écris un compliment précis et sincère que tu pourrais lui faire cette semaine.',
        examples: [
          '"Ta façon d\'expliquer ce dossier était hyper claire, j\'ai tout de suite compris."',
          '"J\'ai trouvé ta remarque en réunion hier super pertinente, ça a changé ma façon de voir le problème."',
        ],
      },
    },
  },
  // Level 2 modules — always required_tier: 'superior'.
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'predict-compare',
        prompt: 'Pense à une personne que tu connais un peu (collègue, connaissance) avec qui tu aimerais approfondir la conversation. Quelle question, légèrement plus personnelle que d\'habitude, pourrais-tu lui poser ?',
        examples: [
          '"Qu\'est-ce qui te motive vraiment dans ce que tu fais ?"',
          '"C\'est quoi un truc dont tu es vraiment fier ces derniers temps ?"',
        ],
      },
    },
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'guided-response',
        prompt: 'Pense à un événement social récent qui te trotte encore en tête. Colonne 1 : ce qui s\'est objectivement passé, factuellement.',
  ...
  },
  {
    ...
    content: {
      ...
      exercise: {
        kind: 'free-plan',
        prompt: 'Liste 3 amis proches. Pour chacun, quand les as-tu contactés pour la dernière fois ?',
        examples: [
...
function sqlArray(arr) {
  return `ARRAY[${arr.map((t) => `'${t.replace(/'/g, "''")}'`).join(', ')}]::text[]`;
}

function sqlJsonb(obj) {
  const json = JSON.stringify(obj);
  // Distinct tag from sqlString's plain $$ so the two dollar-quoted spans
  // per row (title, content) can never be ambiguous to a reader or a script.
  return `$json$${json.replace(/\$json\$/g, '$ json $')}$json$::jsonb`;
}
